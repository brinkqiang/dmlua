...
// tolua_begin
    ...
    void                SetObjID(long long llID){ m_llID = llID;   }
    long long           GetObjID(){ return m_llID; }
...
// tolua_begin
    ...
    void    AddMP(int nMp)   { m_nMP += nMp; }
    void    AddHP(int nHp)   { m_nHP += nHp; }


    void    SetPos(const SPos& stPos){ m_stPos = stPos; }
    SPos&   GetPos(){ return m_stPos; }
