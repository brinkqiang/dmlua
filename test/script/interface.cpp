...
#include "../../include/dmlua/dmlua_luaresult.h"
#include "../../include/dmlua/dmlua_types.h"
...
static int tolua_collect_LuaResult_std__string_ (lua_State* tolua_S) {
    LuaResult<std::string>* self = (LuaResult<std::string>*) tolua_tousertype(
                                       tolua_S,1,0);
    Mtolua_delete(self);
    return 0;
}
...
static int tolua_collect_std__vector_std__string_ (lua_State* tolua_S) {
    std::vector<std::string>* self = (std::vector<std::string>*) tolua_tousertype(
                                         tolua_S,1,0);
    Mtolua_delete(self);
    return 0;
}
...
static int tolua_collect_LuaResult_uint64_t_ (lua_State* tolua_S) {
    LuaResult<uint64_t>* self = (LuaResult<uint64_t>*) tolua_tousertype(tolua_S,1,
                                0);
    Mtolua_delete(self);
    return 0;
}
...
static int tolua_get_STaskInfo_nTaskID(lua_State* tolua_S) {
    ...
    if (!self) {
        tolua_error(tolua_S,"invalid 'self' in accessing variable 'nTaskID'",NULL);
    }
...
static int tolua_get_STaskInfo_nTaskState(lua_State* tolua_S) {
    ...
    if (!self) {
        tolua_error(tolua_S,"invalid 'self' in accessing variable 'nTaskState'",NULL);
    }
...
static int tolua_get_STaskInfo_nTaskCondition(lua_State* tolua_S) {
    ...
    if (!self) {
        tolua_error(tolua_S,"invalid 'self' in accessing variable 'nTaskCondition'",
                    NULL);
    }
...
static int tolua_interface_CObj_SetObjID00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'SetObjID'", NULL);
        }
...
static int tolua_interface_CObj_GetObjID00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'GetObjID'", NULL);
        }
...
static int tolua_interface_CObj_SetName00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'SetName'", NULL);
        }
...
static int tolua_interface_CObj_GetName00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'GetName'", NULL);
        }
...
static int tolua_interface_CRole_SetMp00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'SetMp'", NULL);
        }
...
static int tolua_interface_CRole_GetMp00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'GetMp'", NULL);
        }
...
static int tolua_interface_CRole_SetHp00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'SetHp'", NULL);
        }
...
static int tolua_interface_CRole_GetHp00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'GetHp'", NULL);
        }
...
static int tolua_interface_CRole_AddMP00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'AddMP'", NULL);
        }
...
static int tolua_interface_CRole_AddHP00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'AddHP'", NULL);
        }
...
static int tolua_interface_CRole_SetPos00(lua_State* tolua_S) {
    ...
    if (
        ...
        (tolua_isvaluenil(tolua_S,2,&tolua_err) ||
         !tolua_isusertype(tolua_S,2,"const SPos",0,&tolua_err)) ||
        !tolua_isnoobj(tolua_S,3,&tolua_err)
    ) {
        goto tolua_lerror;
    }
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'SetPos'", NULL);
        }
...
static int tolua_interface_CRole_GetPos00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'GetPos'", NULL);
        }
...
static int tolua_interface_CRole_AcceptTask00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'AcceptTask'", NULL);
        }
...
static int tolua_interface_CRole_FinishTask00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'FinishTask'", NULL);
        }
...
static int tolua_get_LuaResult_int__value(lua_State* tolua_S) {
    ...
    if (!self) {
        tolua_error(tolua_S,"invalid 'self' in accessing variable 'value'",NULL);
    }
...
static int tolua_interface_LuaResult_int64_t__new00(lua_State* tolua_S) {
    ...
    {
        {
            LuaResult<int64_t>* tolua_ret = (LuaResult<int64_t>*)  Mtolua_new((
                                                LuaResult<int64_t>)());
...
static int tolua_interface_LuaResult_uint64_t__new00(lua_State* tolua_S) {
    ...
    {
        {
            LuaResult<uint64_t>* tolua_ret = (LuaResult<uint64_t>*)  Mtolua_new((
                                                 LuaResult<uint64_t>)());
...
static int tolua_interface_LuaResult_double__new00(lua_State* tolua_S) {
    ...
    {
        {
            LuaResult<double>* tolua_ret = (LuaResult<double>*)  Mtolua_new((
                                               LuaResult<double>)());
...
static int tolua_interface_LuaResult_std__string__new00(lua_State* tolua_S) {
    ...
    {
        {
            LuaResult<std::string>* tolua_ret = (LuaResult<std::string>*)  Mtolua_new((
                                                    LuaResult<std::string>)());
...
static int tolua_interface_LuaResult_std__string__new00_local(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
    tolua_Error tolua_err;
...
static int tolua_interface_std_vector_std__string__clear00(lua_State* tolua_S) {
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'clear'", NULL);
        }
...
#endif
    {
        const std::vector<std::string>* self = (const std::vector<std::string>*)
                                               tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE

        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'size'", NULL);
        }
...
static int tolua_interface_std_vector_std__string__push_back00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
    tolua_Error tolua_err;
...
#endif
    {
        ...
        if (!self) {
            tolua_error(tolua_S,"invalid 'self' in function 'push_back'", NULL);
        }
...
static int tolua_interface_std_vector_std__string__new00(lua_State* tolua_S) {
    ...
    {
        {
            std::vector<std::string>* tolua_ret = (std::vector<std::string>*)  Mtolua_new((
...
static int tolua_interface_std_vector_std__string__new00_local(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
    tolua_Error tolua_err;
...
static int tolua_interface_std_vector_std__string__delete00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
    tolua_Error tolua_err;
...
#endif
    {
        const std::vector<int>* self = (const std::vector<int>*)  tolua_tousertype(
                                           tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
static int tolua_interface_std_vector_int__new00(lua_State* tolua_S) {
    ...
    {
        {
            std::vector<int>* tolua_ret = (std::vector<int>*)  Mtolua_new((
                                              std::vector<int>)());
...
TOLUA_API int tolua_interface_open (lua_State* tolua_S) {
    ...
    tolua_variable(tolua_S,"nTaskID",tolua_get_STaskInfo_nTaskID,
                   tolua_set_STaskInfo_nTaskID);
    tolua_variable(tolua_S,"nTaskState",tolua_get_STaskInfo_nTaskState,
                   tolua_set_STaskInfo_nTaskState);
    tolua_variable(tolua_S,"nTaskCondition",tolua_get_STaskInfo_nTaskCondition,
                   tolua_set_STaskInfo_nTaskCondition);
    ...
    tolua_endmodule(tolua_S);
#ifdef __cplusplus
    tolua_cclass(tolua_S,"LuaResult_int_","LuaResult<int>","",
                 tolua_collect_LuaResult_int_);
#else
    tolua_cclass(tolua_S,"LuaResult_int_","LuaResult<int>","",NULL);
#endif
    tolua_beginmodule(tolua_S,"LuaResult_int_");
    tolua_variable(tolua_S,"value",tolua_get_LuaResult_int__value,
                   tolua_set_LuaResult_int__value);
    ...
    tolua_endmodule(tolua_S);
#ifdef __cplusplus
    tolua_cclass(tolua_S,"LuaResult_int64_t_","LuaResult<int64_t>","",
                 tolua_collect_LuaResult_int64_t_);
#else
    tolua_cclass(tolua_S,"LuaResult_int64_t_","LuaResult<int64_t>","",NULL);
#endif
    tolua_beginmodule(tolua_S,"LuaResult_int64_t_");
    tolua_variable(tolua_S,"value",tolua_get_LuaResult_int64_t__value,
                   tolua_set_LuaResult_int64_t__value);
    tolua_function(tolua_S,"new",tolua_interface_LuaResult_int64_t__new00);
    tolua_function(tolua_S,"new_local",
                   tolua_interface_LuaResult_int64_t__new00_local);
    ...
    tolua_endmodule(tolua_S);
#ifdef __cplusplus
    tolua_cclass(tolua_S,"LuaResult_uint64_t_","LuaResult<uint64_t>","",
                 tolua_collect_LuaResult_uint64_t_);
#else
    tolua_cclass(tolua_S,"LuaResult_uint64_t_","LuaResult<uint64_t>","",NULL);
#endif
    tolua_beginmodule(tolua_S,"LuaResult_uint64_t_");
    tolua_variable(tolua_S,"value",tolua_get_LuaResult_uint64_t__value,
                   tolua_set_LuaResult_uint64_t__value);
    tolua_function(tolua_S,"new",tolua_interface_LuaResult_uint64_t__new00);
    tolua_function(tolua_S,"new_local",
                   tolua_interface_LuaResult_uint64_t__new00_local);
    ...
    tolua_endmodule(tolua_S);
#ifdef __cplusplus
    tolua_cclass(tolua_S,"LuaResult_double_","LuaResult<double>","",
                 tolua_collect_LuaResult_double_);
#else
    tolua_cclass(tolua_S,"LuaResult_double_","LuaResult<double>","",NULL);
#endif
    tolua_beginmodule(tolua_S,"LuaResult_double_");
    tolua_variable(tolua_S,"value",tolua_get_LuaResult_double__value,
                   tolua_set_LuaResult_double__value);
    tolua_function(tolua_S,"new",tolua_interface_LuaResult_double__new00);
    tolua_function(tolua_S,"new_local",
                   tolua_interface_LuaResult_double__new00_local);
    ...
    tolua_endmodule(tolua_S);
#ifdef __cplusplus
    tolua_cclass(tolua_S,"LuaResult_std__string_","LuaResult<std::string>","",
                 tolua_collect_LuaResult_std__string_);
#else
    tolua_cclass(tolua_S,"LuaResult_std__string_","LuaResult<std::string>","",NULL);
#endif
    tolua_beginmodule(tolua_S,"LuaResult_std__string_");
    tolua_variable(tolua_S,"value",tolua_get_LuaResult_std__string__value,
                   tolua_set_LuaResult_std__string__value);
    tolua_function(tolua_S,"new",tolua_interface_LuaResult_std__string__new00);
    tolua_function(tolua_S,"new_local",
                   tolua_interface_LuaResult_std__string__new00_local);
    tolua_function(tolua_S,".call",
                   tolua_interface_LuaResult_std__string__new00_local);
    tolua_function(tolua_S,"delete",
                   tolua_interface_LuaResult_std__string__delete00);
    tolua_endmodule(tolua_S);
    tolua_module(tolua_S,"std",0);
    tolua_beginmodule(tolua_S,"std");
#ifdef __cplusplus
    tolua_cclass(tolua_S,"vector_std__string_","std::vector<std::string>","",
                 tolua_collect_std__vector_std__string_);
#else
    ...
    tolua_function(tolua_S,"push_back",
                   tolua_interface_std_vector_std__string__push_back00);
    tolua_function(tolua_S,"new",tolua_interface_std_vector_std__string__new00);
    tolua_function(tolua_S,"new_local",
                   tolua_interface_std_vector_std__string__new00_local);
    tolua_function(tolua_S,".call",
                   tolua_interface_std_vector_std__string__new00_local);
    tolua_function(tolua_S,"delete",
                   tolua_interface_std_vector_std__string__delete00);
    tolua_endmodule(tolua_S);
#ifdef __cplusplus
    tolua_cclass(tolua_S,"vector_int_","std::vector<int>","",
                 tolua_collect_std__vector_int_);
#else
